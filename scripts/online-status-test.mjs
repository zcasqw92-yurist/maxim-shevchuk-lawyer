...
const boundaries = [
  ["07:59", "2026-07-26T04:59:00.000Z", false],
  ["08:00", "2026-07-26T05:00:00.000Z", true],
...
assert(moscowHour(new Date("2026-01-15T05:00:00.000Z")) === 8, "Зимнее время должно вычисляться по Москве");
assert(moscowHour(new Date("2026-07-15T05:00:00.000Z")) === 8, "Летнее время должно вычисляться по Москве");
...
console.log("Online status 08:00–23:00 MSK: OK");
