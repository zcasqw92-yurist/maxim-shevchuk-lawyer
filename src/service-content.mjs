export const servicePageContent = {
  "dosudebnoe-uregulirovanie": {
    ...
    title: "Досудебное урегулирование споров до обращения в суд",
    lead: "Проверю документы и доказательства, определю правовую позицию, рассчитаю требования и подготовлю претензию или другой досудебный документ. Задача — попытаться решить спор без суда и одновременно сохранить основу для следующего этапа защиты.",
    ...
    cardItems: ["Договор или подтверждение договорённости", "Платежи, акты и переписка", "Ответ, отказ или сведения о молчании"],
    situationsTitle: "Когда спор стоит решать в досудебном порядке",
    resultTitle: "Позиция, требования и план дальнейших действий",
    ...
    process: [
      ...
      ["Досудебная позиция", "Готовлю претензию, требование, ответ или переговорную позицию с понятным сроком исполнения."],
    ...
    ctaText: "Кратко опишите хронологию, сумму, свои требования и реакцию второй стороны. Первично посмотрю основные документы бесплатно и объясню, с чего разумнее начать.",
  },
  "vzyskanie-dolga": {
    eyebrow: "Долги и займы",
    title: "Взыскание долга по расписке, договору, переводу или переписке",
    lead: "Проверю, чем подтверждаются передача денег и обязанность их вернуть, рассчитаю остаток и проценты, подготовлю требование и определю дальнейшую процедуру. Первично посмотрю основные материалы бесплатно.",
    ...
    situationsTitle: "Когда нужна отдельная позиция по взысканию долга",
    resultTitle: "Доказательственная цепочка, расчёт и документ",
    resultNote: "До подготовки документа объясню, какие суммы подтверждены, какой срок возврата действует и требуется ли приказ, иск или сначала письменное требование.",
    ...
    ctaText: "Сообщите сумму, даты, получателя переводов, условия возврата и что должник писал после наступления срока. По этим данным можно определить сильные и слабые места позиции.",
  },
  "vozvrat-deneg": {
    eyebrow: "Возврат оплаты и аванса",
    title: "Возврат денег за товар, услугу или работу",
    lead: "Определю законное основание возврата, проверю доказательства оплаты и фактического исполнения, рассчитаю требования. Первично ознакомлюсь с материалами бесплатно и объясню порядок действий.",
    topic: "возврат денежных средств за товар, услугу или работу",
