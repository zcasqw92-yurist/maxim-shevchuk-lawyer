...
const commonReplacements = [
  [
    ...
    '<h1>Передайте ситуацию — разберусь и объясню следующий шаг</h1>',
  ],
  [
    ...
    '<p class="hero__lead">Коротко опишите, что произошло, и приложите документы. Первично ознакомлюсь бесплатно и объясню, нужна претензия, жалоба или иск.</p>',
  ],
