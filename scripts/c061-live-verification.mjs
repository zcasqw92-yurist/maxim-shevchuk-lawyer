...
const expectedSha = "333238a3c19cce3c271922a8a328c7ff5dd401cf";
const articlePath = "/razbory/tovar-ne-postavlen-posle-oplaty-scheta/";
const articleUrl = `${siteUrl}${articlePath}`;
const catalogUrl = `${siteUrl}/razbory/`;
const expectedH1 = "Оплатили счёт, а товар не поставили: как ИП вернуть деньги без подписанного договора";
const linkedService = "/uslugi/dosudebnoe-uregulirovanie/";
const attempts = 60;
const delayMs = 10000;
...
if (!articleHtml.includes(linkedService)) throw new Error("Нет ссылки на связанную услугу");
