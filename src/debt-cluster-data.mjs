...
const sellerDisappearedArticle = {
  ...
  sections: [
    ...
    {
      id: "practice",
      title: "Что показывает оплаченная юридическая практика",
      paragraphs: [
      ...
      note: "Практический вывод: документ должен не просто сообщать о потере денег, а давать проверяемую хронологию, доказательства и перечень конкретных действий для адресата.",
    },
    {
      id: "mistakes",
