...
const commonReplacements = [
  [
    ...
    '<h1>Досудебное урегулирование споров — до обращения в суд</h1>',
  ],
  [
    ...
    '<p class="hero__lead">Основная специализация — досудебное урегулирование: анализирую документы, рассчитываю требования, готовлю претензию и выстраиваю позицию так, чтобы попытаться решить спор без суда и сохранить доказательства для следующего этапа.</p>',
  ],
  [
    '<div><span class="eyebrow">Направления практики</span><h2>Юридическая помощь под задачу</h2></div>',
    '<div><span class="eyebrow">Основная специализация</span><h2>Досудебное урегулирование и связанные направления</h2></div>',
  ],
  [
    '<p>Каждое направление — отдельная логика работы, доказательств и требований.</p>',
    '<p>Сначала оценивается возможность решить спор до суда. Возврат денег, договорные споры, жалобы и подготовка иска показаны как связанные этапы одной правовой позиции.</p>',
  ],
  [
    ...
    '<span class="eyebrow">Структура практики</span><h1>Досудебное урегулирование — основа юридической работы</h1><p>Основная задача — попытаться разрешить спор до суда и одновременно подготовить доказательства на случай жалобы или иска. Остальные направления показаны по их роли в этой последовательности.</p>',
  ],
