...
const url = "https://yuristshevchuk.com/razbory/tovar-ne-postavlen-posle-oplaty-scheta/?overflow_debug=1";
    ...
    const offenders = [...document.querySelectorAll("*")]
      .map((element) => {
        ...
        return {
          ...
          text: String(element.textContent || "").replace(/\s+/g, " ").trim().slice(0, 220),
        };
      })
