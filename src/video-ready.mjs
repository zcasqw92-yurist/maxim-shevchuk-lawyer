...
const videoDialog = () => {
  ...
  <dialog class="video-placeholder-dialog video-ready-dialog" id="video-placeholder-dialog" aria-labelledby="video-placeholder-title" data-video-dialog>
    ...
    : "В ролике Максим Юрьевич объяснит, что не нужно заранее выбирать юридический документ: достаточно кратко описать, что произошло, и показать основные материалы."}</p>
